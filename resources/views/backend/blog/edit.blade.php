                ...
                <div class="form-group breadcrumb-right">
                    <div class="dropdown">
                        <a class="btn btn-primary waves-effect waves-float waves-light"
                            href="{{ route('admin.blog.index') }}">Back</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <hr />
                                         <div class="form-group mt-3">
                                            <img id="preview-image-before-upload" src="{{ asset('images') . '/' . $blog->image }}" width="250px" alt="your image" />
                                        </div>
                                ...
                                <div class="col-md-8 col-12">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('admin.blog.update', $blog) }}" class="needs-validation"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="basic-addon-name"
                                                    value="{{ $blog->name }}" class="form-control" placeholder="Name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="date" id="basic-addon-name"
                                                    value="{{ $blog->date }}" class="form-control" placeholder="date"
                                                    aria-label="date" aria-describedby="basic-addon-name" />
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">Please enter your name.</div>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control ckeditor" name="description" id="validationBioBootstrap" rows="3">{{ $blog->description }}</textarea>
                                            </div>
                                            <div class="row">
                                                <div class="col-12">

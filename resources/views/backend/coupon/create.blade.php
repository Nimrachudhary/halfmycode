        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Create Coupon</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card">
                            <div class="row">
                                ...
                                <div class="col-md-8 col-12">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('admin.coupon.store') }}" class="needs-validation"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="coupon_title" id="basic-addon-name"
                                                    class="form-control" placeholder="Title" aria-label="Name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="coupon_code" id="basic-addon-name"
                                                    class="form-control" placeholder="Coupon Code" aria-label="title"
                                                    aria-describedby="basic-addon-name" required />
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">Please enter your name.</div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="Affilate_Link" id="basic-addon-name"
                                                    class="form-control" placeholder="Affilate Link" aria-label="title"
                                                    aria-describedby="basic-addon-name" required />
                                                <div class="valid-feedback">Looks good!</div>
                                                <div class="invalid-feedback">Please enter your name.</div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="expiry_date" id="basic-addon-name"
                                                    class="form-control" placeholder="Expiry Date" aria-label="title"
                                                    aria-describedby="basic-addon-name" required />
                                                <div class="valid-feedback">Looks good!</div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="description" id="validationBioBootstrap" rows="3" required></textarea>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio my-50">
                                                    <input type="radio" id="validationRadio3" value="getdeal"
                                                        name="Cupon_type" class="custom-control-input" required />
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="checkbox"value="1"  id="top_voucher" name="top_voucher" />

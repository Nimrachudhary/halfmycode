                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.footer.store') }}" class="needs-validation" method="post" novalidate enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    <div class="form-group">
                                        <label class="d-block" for="validationBioBootstrap">Description</label>
                                        <textarea class="form-control" name="footer_description" id="footer_description" rows="3" required>
                                            @if (count($data)>0)
                                            {{$data[0]->footer_description}}
                                             @endif
                                        </textarea>
                                    </div>
                                    <div class="row">

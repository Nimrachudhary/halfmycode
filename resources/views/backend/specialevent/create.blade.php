    ...
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-left mb-0">Create Special Event</h2>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="col-md-4 col-12">
                            <div class="card-header">
                                <h4 class="card-title">Enter Special Event Detail Here.</h4>
                            </div>
                            <div class="card-body">
                                <p>
                        ...
                        <div class="col-md-8 col-12">
                            ...
                            <div class="card-body">
                                <form action="{{ route('admin.event.store') }}" class="needs-validation" method="post" novalidate enctype="multipart/form-data">
                                    @csrf
                                    @method('POST')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" id="basic-addon-name" class="form-control" placeholder="title" aria-label="title" aria-describedby="basic-addon-name" required />
                                        <div class="valid-feedback">Looks good!</div>
                                        <div class="invalid-feedback">Please enter your name.</div>
                                    </div>
